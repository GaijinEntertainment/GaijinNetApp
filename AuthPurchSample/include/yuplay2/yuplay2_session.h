...
struct IYuplay2Session
{
  ...
  virtual Yuplay2Status YU2VCALL psnLoginAsync(const char* auth_code,
                                               const char* game_id,
                                               int issuer,
                                               const char* lang, Yuplay2AsyncCall* call) = 0;
  ...
  virtual Yuplay2Status YU2VCALL xboxLoginSync(const char* user_hash, const char* game_id) = 0;
  virtual Yuplay2Status YU2VCALL xboxLoginAsync(const char* user_hash, const char* game_id,
                                                Yuplay2AsyncCall* call) = 0;
  ...
  virtual Yuplay2Status YU2VCALL googlePlayLoginSync(const char* code) = 0;
  ...
  virtual Yuplay2Status YU2VCALL linkXboxSync(const char* email, const char* user_hash,
                                              const char* game_id) = 0;
  virtual Yuplay2Status YU2VCALL linkXboxAsync(const char* email, const char* user_hash,
                                               const char* game_id, Yuplay2AsyncCall* call) = 0;
